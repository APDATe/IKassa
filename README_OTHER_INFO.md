...
### Метод  ПрочаяИнформация().Закрыть("http://192.168.111.212:37015/v1", "75928")
...
//Создаем новый экземпляр класса ПрочаяИнформация();	
Документ =  МояКасса.ПрочаяИнформация();

//Выполняем метод Закрыть(string "URL", string "PinKod") класса ПрочаяИнформация();
